...
class ZoomButtons extends Component {
	...
	render() {
		...
		return (
			<g className="whalestats-stockcharts-zoom-button">
				<rect
					x={zoomOutX - w / 2}
					y={y}
					rx={rx}
				...
				<path d={zoomIn.toString()}
					...
					strokeWidth={textStrokeWidth}
				/>
				<rect className="whalestats-stockcharts-enable-interaction out"
					...
					fill="none"
				/>
				<rect className="whalestats-stockcharts-enable-interaction reset"
					onClick={onReset}
					x={resetX - w / 2}
					y={y}
					rx={rx}
					...
					fill="none"
				/>
				<rect className="whalestats-stockcharts-enable-interaction in"
